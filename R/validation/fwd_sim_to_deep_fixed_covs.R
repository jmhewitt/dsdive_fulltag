fwd_sim_to_depth_fixed_covs = function(
  stages, depths, covariates, n_max, nim_pkg, lambda, betas_tx, template_bins, 
  depth_threshold, deeper = TRUE
) {
  # forward-sampling of dive while holding time-based covariates fixed at their 
  # input values
  #
  # Parameters:
  ...
  while(n_sampled < n_max) {
    ...
    # copy forward last set of covariates
    covariates[,ind+1] = covariates[,ind]
