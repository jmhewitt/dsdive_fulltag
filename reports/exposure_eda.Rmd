...
<span style="color:blue">`r params$window_length`</span> hours before an exposure, 
and depth bins observed in the first 
<span style="color:blue">`r params$window_length`</span> hours after exposure.  
...
consecutive <span style="color:blue">`r params$window_length`</span>-hour sequences 
of unexposed depth bin observations.  The null distribution is approximated via 
sampling.

### Sampling units

Studying consecutive <span style="color:blue">`r params$window_length`</span>-hour 
...
<span style="color:blue">`r params$window_length`</span>-hour windows in order to 
